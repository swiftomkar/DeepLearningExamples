...
spark-submit --master $MASTER \
    ...
    --conf spark.rapids.sql.reader.batchSizeRows=4000 \
...
head -n $former $last_day > $temp_test/day_1
tail -n $latter $last_day > $temp_validation/day_1
